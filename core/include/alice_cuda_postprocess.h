...
namespace ALICE_TRACER{
    ...
    // ----------------------------
    static inline __device__ glm::vec3 toGammaSpace(const glm::vec3 & col){
    ...
    // ----------------------------
    static inline __device__ glm::vec3 toLinearSpace(const glm::vec3 & col){
    ...
    // ----------------------------
    static inline __device__ void assignPixel(float * img, const int & id, glm::vec3 & col){
